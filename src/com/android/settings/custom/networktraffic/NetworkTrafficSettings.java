...
public class NetworkTrafficSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        boolean isNetMonitorEnabled = Settings.Secure.getIntForUser(resolver,
                Settings.Secure.NETWORK_TRAFFIC_STATE, 1, UserHandle.USER_CURRENT) == 1;
        mNetMonitor = (SecureSettingMainSwitchPreference) findPreference("network_traffic_mode");
        mNetMonitor.setChecked(isNetMonitorEnabled);
        mNetMonitor.setOnPreferenceChangeListener(this);

        boolean isThresholdEnabled = Settings.Secure.getIntForUser(resolver,
                Settings.Secure.NETWORK_TRAFFIC_AUTOHIDE_THRESHOLD, 0, UserHandle.USER_CURRENT) == 1;
        mThreshold = (SecureSettingSwitchPreference) findPreference("network_traffic_autohide");
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if (preference == mNetMonitor) {
            ...
            Settings.Secure.putIntForUser(getActivity().getContentResolver(),
                    Settings.Secure.NETWORK_TRAFFIC_MODE, value ? 1 : 0,
